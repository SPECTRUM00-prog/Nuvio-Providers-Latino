 ...
 * Arquitectura: API REST JSON Oficial (tmdb2.cuevana3.gs)
 * Compatible con Android TV y FireTV (Hermes Engine - 100% Promise Chains)
 */

var TMDB_API_KEY = "439c478a771f35c05022f9feabcca01c";
var API_BASE = "https://tmdb2.cuevana3.gs";
...
// ==========================================
// 5. EXTRACTOR VÍA API DE LAMOVIE
// ==========================================
...
function fetchFileCode(tmdbId, isTv, seasonNum, episodeNum) {
    ...
    if (!isTv) {
        ...
        return fetchWithTimeout(endpoint, { headers: DEFAULT_HEADERS }, NETWORK_TIMEOUT)
            ...
            .then(function(json) {
                if (json && json.item && json.item.code && json.item.playable !== false) {
        ...
        return fetchWithTimeout(endpoint, { headers: DEFAULT_HEADERS }, NETWORK_TIMEOUT)
            ...
            .then(function(json) {
                if (json && json.episode && json.episode.code && json.episode.playable !== false) {
