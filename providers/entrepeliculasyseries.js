/**
 * Provider: EntrePeliculasySeries (Películas, Series y Anime en Latino, Castellano y Sub)
 * Dominio: https://entrepeliculasyseries.nz
 * Motor: 100% Cadenas de Promesas (Compatible con Hermes / FireTV / Desktop)
 */

const TMDB_API_KEY = "439c478a771f35c05022f9feabcca01c";
const BASE_URL = "https://entrepeliculasyseries.nz";
...
function getStreams(tmdbId, mediaType, season, episode) {
    console.log(`[EntrePeliculasySeries] Buscando TMDB ID ${tmdbId} (${mediaType})`);
    ...
    return fetch(tmdbUrl)
        ...
        .catch(function(err) {
            console.log(`[EntrePeliculasySeries] Error: ${err.message}`);
            return [];
        });
}
